...
{
    $url = 'https://www.facebook.com/logout.php?next=' . urlencode('http://gigaparse.com/clients/praysocially/fb/') .
...
if(isset($_GET['fbTrue']))
{
    ...
    echo  $extra = "<a href='index.php?logout=1&tocken=".$params['access_token']."'>Logout</a><br>";     
     $content = $user;
}
else
{
